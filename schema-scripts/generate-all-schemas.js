...
const pages = [
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Set permissions, enable SSO, manage timezones & languages, and protect event data with Swapcard's secure, centralized admin tools for event teams."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Use Swapcard to turn exhibitors and sponsors into advocates with lead capture, matchmaking, and real-time ROI tools—all in one platform."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Boost attendee engagement before, during, and after your event with Swapcard. From AI-powered networking to interactive sessions and real-time chat, create meaningful experiences that deliver ROI."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Monetize your B2B event with Swapcard. Boost exhibitor ROI, increase sponsorship revenue, and unlock new revenue streams with lead capture, AI, and brand visibility tools."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Sell more tickets and drive attendance with Swapcard's event registration software. Discover how to deliver a seamless, easy-to-use experience for all."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Swapcard Go simplifies check-in & on-site registration for trade shows & conferences. Get essential hardware delivered & expert support to run smooth events."
    },
  ...
  },
  {
    ...
    slug: "widgets",
    seo: {
      title: "Swapcard Widgets | The easiest way to boost your event's online presence",
      description: "Boost engagement with Swapcard's interactive widgets. Enhance interactivity, track analytics & optimize networking for a seamless event experience."
    },
  ...
  // Solutions
  {
    ...
    seo: {
      ...
      description: "Plan and manage successful events with Swapcard's powerful event planning and management software platform, perfect for small business event organizers."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Boost member retention & engagement with Swapcard's event software for associations. Simplify admin tasks, manage CE tracking & enhance networking. Contact us!"
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Optimize trade shows with Swapcard's event lead retrieval and exhibitor lead capture tools. Enhance engagement and streamline event planning seamlessly."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Manage events with ease using Swapcard's event management & ticketing software. Simplify registration, ticketing, & on-site check-ins for a seamless experience."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Enhance your medical congress with our event management software, featuring interactive tools, automated CME tracking, and tailored exhibitor solutions."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Discover event management software for media companies. Create engaging experiences with multimedia, polls, and live chat. Maximize revenue with targeted ads."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Maximize exhibitor and sponsor ROI with advanced lead generation, customizable booths, and flexible packages that enhance visibility and drive revenue."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Drive event revenue growth with Swapcard's platform. Implement new revenue streams and boost overall profitability for your events."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Optimize your events with data-driven insights from Swapcard's platform. Enhance performance and engagement."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Use Swapcard's event registration software to streamline attendee check-ins, print badges onsite, and manage registrations with ease. Try our platform now!"
    },
  ...
  // Resources
  {
    ...
    seo: {
      ...
      description: "Access free event industry resources with Swapcard. Download guides, case studies & expert insights to optimize event strategies & stay ahead of trends."
    },
  ...
  },
  {
    ...
    seo: {
      title: "State of Event Engagement Vol. 2 | Insights for Trade Shows & Associations ",
      description: "Get insights from 1,100+ trade show and association events with 6 million attendees. Learn about emerging trends in AI, networking, engagement & revenue growth."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Discover how sales & marketing directors monetize digital leads, drive engagement, and accelerate renewals with proven event growth strategies."
    },
    publishedPath: "/resources/sales-marketing-teams-executive-playbook-engagement-roi",
    category: "resources"
  },
  {
    ...
    slug: "media-kit",
    seo: {
      title: "Swapcard Media Kit & Newsroom - Logos, Product Images, Collateral & News",
      description: "Discover our comprehensive media kit, designed to provide event organizers and professionals with everything they need to promote our brand at their next event."
    },
  ...
  // Platform
  {
    ...
    seo: {
      ...
      description: "Discover Swapcard's all-in-one event engagement platform. Create interactive and engaging experiences for  in-person, hybrid, and virtual events."
    },
    publishedPath: "/platform/event-engagement",
    category: "platform"
  },
  {
    id: "64d3914e6761bd389818d6f4",
    title: "Integrations",
    slug: "integrations",
    seo: {
      title: "Swapcard Integrations | Connect Salesforce, Cvent & More",
      description: "Automate event management with Swapcard's software integrations. Connect with Salesforce, Cvent & top event tech tools for seamless operations. Contact us!"
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Swapcard holds 2022 SOC 2 Type 2 certification, ensuring the highest industry security standards for data protection and compliance. Contact us for more!"
    },
  ...
  // Legal
  {
    ...
    seo: {
      ...
      description: "Read Swapcard's privacy policy to understand how we collect, use, and protect your personal information, ensuring transparency and your data rights."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Read the terms and conditions for users on Swapcard, detailing your rights and responsibilities while using our event management platform."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Review Swapcard's terms for event organizers. Learn your rights and responsibilities to ensure a seamless and successful event experience. Contact us for more!"
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Explore the latest insights about event engagement on the Swapcard blog. Get expert tips, trends, and advice to elevate your events."
    },
    publishedPath: "/blog",
    category: "other"
  },
  {
    ...
    seo: {
      ...
      description: "Have a question or suggestion? Contact the Swapcard team anytime—we're here to help with your event needs & platform support. Contact us for more information!"
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Get a custom demo to explore how Swapcard's intuitive platform and AI-powered capabilities help enhance attendee engagement and exhibitor ROI, and grow revenue."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Learn more about Swapcard! Discover our mission, values, and how our AI-powered event technology is transforming the industry. Explore our story now!"
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Work from anywhere with Swapcard! Spread across 28 countries, we offer a flexible, comfortable work environment that supports remote and global collaboration."
    },
  ...
  },
  {
    ...
    seo: {
      ...
      description: "Simplify event management for onsite and hybrid events with Swapcard's intuitive event mobile app—designed to boost engagement and streamline operations."
    },
...
function generateBreadcrumb(page) {
  ...
  const pathSegments = page.publishedPath.split('/').filter(segment => segment);
...
// Function to determine schema type based on page category
    ...
    case 'pricing':
      return {
        ...
        "offers": {
          ...
          "seller": { "@id": "https://www.swapcard.com/#org" }
        }
      };
    default:
      return null;
    ...
    "@graph": [
      {
        ...
        "url": `https://www.swapcard.com${page.publishedPath}/`,
        "name": page.seo.title,
        "inLanguage": "en",
        "description": page.seo.description,
...
pages.forEach(page => {
  ...
  const filePath = path.join(__dirname, category, `${fileName}-schema.html`);
